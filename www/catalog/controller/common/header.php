...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['liders'] = $this->url->link('liders/liders', '', 'SSL');
		$this->data['latest'] = $this->url->link('latest/latest', '', 'SSL');
		$this->data['special'] = $this->url->link('product/special');
		$this->data['affiliate'] = $this->url->link('affiliate/account', '', 'SSL');
		$this->data['contact'] = $this->url->link('information/contact');
		$this->data['information4'] = $this->url->link('information/information', 'information_id=4');
		$this->data['information7'] = $this->url->link('information/information', 'information_id=7');
