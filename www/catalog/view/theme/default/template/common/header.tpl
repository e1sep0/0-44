...
<div id="menu">
  <ul>
    ...
    <?php } ?>
	<li><a href="<?php echo $latest; ?>">Новые товары</a></li>
	<li><a href="<?php echo $liders; ?>">Лидеры продаж</a></li>
	<li><a href="<?php echo $special; ?>">Спецпредложения</a></li>
	<li><a href="http://vk.com/o44ru" target="_blank">Сообщество</a></li>
	<li><a href="<?php echo $information7; ?>">Партнерам</a></li>
	<li><a href="<?php echo $contact; ?>">Обратная связь</a></li>
	<li><a href="<?php echo $information4; ?>">FAQ</a></li>
